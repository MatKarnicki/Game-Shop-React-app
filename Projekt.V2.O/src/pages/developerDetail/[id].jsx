  ...
  return (
    <div>
      ...
      <h4>
        ...
        cum modi laudantium deserunt? Dolorem, reprehenderit. Eaque, temporibus?
        Quo, maiores earum. Non libero ad animi maxime, magni, iusto explicabo
        iure neque expedita eveniet, eos earum vel qui sed unde architecto
        quisquam amet! Vero ullam eaque magnam quos placeat amet suscipit iusto.
        Eaque ad modi doloribus pariatur iure recusandae, illo labore voluptates
        rem sunt, vitae aut?
      </h4>
      <GameGrid games={developerDetail?.my_games} />
    </div>
  );
};
