...
import GameDetailsForm from "../forms/GameDetailsForm";
  ...
  return (
    <div style={{ display: "flex" }}>
      <div style={{ marginLeft: "40px", width: "55  %" }}>
        ...
        ></Image>
        <h3>
          {gameDetail?.tba ? "TBA " : `Released: ${gameDetail?.released}`}
        </h3>
        ...
        <h4>
          ...
          omnis illum at quia amet, aut similique nostrum id itaque voluptas
          nemo beatae vero, dolorem laudantium. Corporis voluptatem neque
          dignissimos dolore debitis veniam iure. Obcaecati quos voluptates
          possimus, delectus voluptatem culpa minima sed totam quam dolores
          corrupti nulla nostrum dignissimos pariatur iure ea, soluta tempora
          eaque. In, animi odio dicta accusantium dolores debitis sed vero
          optio! Autem dicta libero culpa rem, quia fugiat dignissimos
          distinctio minima, quisquam inventore ipsum ad cum pariatur vitae fuga
          eum. Quos quo odio saepe nesciunt dolorum iste in nemo tempore amet
          distinctio iure, id omnis porro quia sequi veniam! Veniam, ipsa atque
          consequatur ducimus similique voluptatibus minima exercitationem
          suscipit quaerat nemo amet quisquam ex dolore iure enim laboriosam
          doloremque itaque dolorem aperiam accusantium! Libero unde eius magnam
          nemo eaque qui repudiandae vel laboriosam, vitae natus similique quia
          enim, perferendis sapiente debitis. Reprehenderit cumque sapiente,
          consequatur nisi obcaecati voluptas temporibus quis ullam nemo
